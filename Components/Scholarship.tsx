...
function Scholarship() {
  return (
    <>
      <div className="banner2 h-[1152px] md:h-[523px] relative">
        <div className="absolute top-0 bg-[#1E2641]/[0.89] h-full w-full"></div>
        <div className=" mx-[20px] md:mx-[223px] bg-[white] rounded-[17px] flex flex-col items-center px-[11px] md:px-[53px] absolute top-[-56%] md:top-[-96%] pb-[38px]">
          <h2 className="font-Palatino font-bold text-[25px] md:text-[28px] leading-[37.78px] text-[#484848] pt-[44px] text-center md:text-left ">
          ...
          />
          <p className="font-Poppins font-normal text-[16px] leading-[25.6px] tracking-[1%] text-[#484848] pt-[26px] text-center">
        ...
        <div className="container mx-auto absolute top-[5px] md:top-[80px] md:left-[85px]">
          ...
          <div className="flex flex-col md:flex-row justify-between absolute left-[10px] md:left-[50px] container mx-auto ">
            <div className="basis-[70%]">
              <h2 className="font-Palatino font-bold text-[35px] leading-[47px] text-[white] pt-[120px]">
                SCHOLARSHIP AVAILABLE
              </h2>
              <p className="font-Poppins font-normal text-[18px] leading-[27px] text-white max-w-[704px]">
            ...
            <div className="basis-[30%]">
             ...
             gap-[10px] items-center mt-[150px] ml-[127px] xl:ml-[92px] 2xl:ml-[170px] "
              >
